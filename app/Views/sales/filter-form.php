<form action="<?php echo BASE_URL . 'sales/sales-filters' ?>" method="post">
    <div class="row">
        ...
        <div class="col-md-2">
            <input type="number" class="form-control" name="author_id" placeholder="Search By Author ID" autocomplete="off">
        </div>
