...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">RealEstate Users</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header border-transparent">
              ...
              <h3 class="card-title">Wire.RealEstate Users</h3>
            ...
            <div class="table-responsive">
              <table class="table m-0">
                ...
                <tbody>
                  ...
                  <?php
                  if(isset($realestate_users['users'])){

                  foreach($realestate_users['users'] as $user){ ?>
  ...
  $(document).on('click', '.verify_pr_now', function(){  
        ...
        $.ajax({
          url:'<?php echo BASE_URL.'kiosk-users/get_kiosk_user_details_ajax/'; ?>',
          type: 'POST',
          dataType: 'html',
          data:{
            user_id
