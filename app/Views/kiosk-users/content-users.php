          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Content Users</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header border-transparent">
              ...
              <h3 class="card-title">Content Marketing Users</h3>
            ...
            <div class="table-responsive">
              <table class="table m-0">
                ...
                <tbody>
                  ...
                  <?php
                  if(isset($content_users['users'])){

                  foreach($content_users['users'] as $user){ ?>
