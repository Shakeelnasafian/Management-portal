    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="padding: 10px 0 30px 0;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="99%" style="border: 1px solid #cccccc; border-collapse: collapse;">
                    <tr>
                        <td align="center" bgcolor="#123282" style="padding: 40px 0 30px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
                                        <img src="https://icnimage.s3.us-west-2.amazonaws.com/1614245358icn-logo.png">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top" class="m_673648386557340003mcnTextContent" style="color:#000000;font-family:Georgia,Times,'Times New Roman',serif;font-size:14px;font-weight:normal;line-height:18px;text-align:left;word-break:break-word;padding:0px">

                                        <p><strong>Dear <?php echo $full_name ?>,</strong></p>
                                        <p>Please click the link below to verify your account<br>
                                            <strong>Verification link: <a href="<?php echo $verification_link ?>">Click here </a></strong>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top" class="m_673648386557340003mcnTextContent" style="padding-top:9px;padding-right:18px;padding-bottom:9px;padding-left:18px;word-break:break-word;color:#202020;font-family:Georgia,Times,'Times New Roman',serif;font-size:12px;line-height:150%;text-align:left">
                                        ...
                                        <img alt="exampleNewswire" height="39" src="https://icnimage.s3.us-west-2.amazonaws.com/1614245593icn_logo.jpg" width="39" style="border:0;height:auto!important;outline:none;text-decoration:none" class="CToWUd"><em>Copyright Â© <?php echo date('Y') ?> exampleNewswire, All rights reserved.</em><br>
                                        <br>
                    ...
                    <tr>
                        <td bgcolor="#123282" style="padding: 30px 30px 30px 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center">
