...
<body class="hold-transition sidebar-mini">
      ...
      <section class="content">
        <div class="card card-success ">
          <div class="card-header main-container-header">
            <h3 class="card-title">Create Master Distribution Report</h3>
          </div>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="AI" id="campaign_AI" placeholder="Enter Achieved Views" autocomplete="off">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label>Total Clicks</label>
                            <input type="number" class="form-control" name="TC" id="campaign_TC" placeholder="Enter Total Clicks">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="PA" id="campaign_PA" placeholder="Enter Potential Audience" autocomplete="off">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label>Exact Matches</label>
                            <input type="number" class="form-control" name="EM" id="campaign_EM" placeholder="Enter Exact Matches">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="keywords" placeholder="Enter Targeted Keywords" autocomplete="off">
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-sm-7">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="geoT" id="geoT" placeholder="Enter Geographic Targeting" autocomplete="off">
                          </div>
                        </div>
                        <div class="col-sm-5">
                          <div class="form-group">
                            <label>Age Group</label>
                            <input type="text" class="form-control" name="ageGroup" id="ageGroup" placeholder="Enter Age Group">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7">
                          ...
                          <div class="form-group">
                            <div class="custom-control custom-checkbox checkbox-inline">
                              <input class="custom-control-input Tnetworks" type="checkbox" id="facebook" name="Facebook" value="Facebook">
                              <label for="facebook" class="custom-control-label">Facebook</label>
                            </div>
                            <div class="custom-control custom-checkbox checkbox-inline">
                              <input class="custom-control-input Tnetworks" type="checkbox" id="google" name="Google" value="Google">
                              <label for="google" class="custom-control-label">Google</label>
                            </div>
                            <div class="custom-control custom-checkbox checkbox-inline">
                              <input class="custom-control-input Tnetworks" type="checkbox" id="linkedIn" name="LinkedIn" value="LinkedIn">
                        ...
                        <div class="col-sm-5">
                          ...
                          <div class="form-group">
                            <div class="custom-control custom-checkbox radio-button-inline-no-top">
                              <input class="custom-control-input" type="checkbox" id="female" name="Female" value="0">
                              <label for="female" class="custom-control-label">Female</label>
                            </div>
                            <div class="custom-control custom-checkbox radio-button-inline-no-top">
                              <input class="custom-control-input" type="checkbox" id="male" name="Male" value="1">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>Achieved Views </label>
                          <input type="number" class="form-control" name="fbAI" id="fbAI" placeholder="Enter Achieved Views" autocomplete="off">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="fbTLC" id="fbTLC" placeholder="Enter Total Link Clicks" autocomplete="off">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>Achieved Views</label>
                          <input type="number" class="form-control" name="gAI" id="gAI" placeholder="Enter Achieved Views" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Total Link Clicks</label>
                          <input type="number" class="form-control" name="gTLC" id="gTLC" placeholder="Enter Total Link Clicks">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>Achieved Views </label>
                          <input type="text" class="form-control" id="linkAI" name="linkAI" placeholder="Enter Achieved Views" autocomplete="off">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>Total Link Clicks </label>
                          <input type="text" class="form-control" id="linkTLC" name="linkTLC" placeholder="Enter Link Clicks" autocomplete="off">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <!-- text input -->
                        <div class="form-group">
                          <label for="fbDI">Graph information</label>
          ...
          <div class="row">
              <div class="col-md-6">
                <form id="lexusnexus_campaign_form" name="lexusnexus_campaign_form" method="post" enctype="multipart/form-data" action="#">
                  <div class="card card-info">
                    <div class="card-header first-row">
                      <h3 class="card-title">Lexis Nexis and Factiva</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                     <div class="row">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          <label>Achieved Views</label>
                          <input type="number" class="form-control" name="pwAI" id="pwAI" placeholder="Enter Achieved Views" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label>Total Clicks</label>
                          <input type="number" class="form-control" name="pwTLC" id="pwTLC" placeholder="Enter Total Clicks">
                        </div>
                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control site_name"  name="site_name[]" placeholder="Site One Name" autocomplete="off">
                      </div>
                      <div class="col-sm-3">
                        <label>Achieved Impressions</label>
                        <input type="text" class="form-control achived_views"  name="achived_views[]" placeholder="Achieved Impressions" autocomplete="off">
                      </div>
                      <div class="col-sm-3">
                        <label>Achieved Clicks</label>
                        <input type="text" class="form-control achived_clicks"  name="achived_clicks[]" placeholder="Achieved Clicks" autocomplete="off">
                      </div>
                    </div>
                    <hr>
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control site_name"  name="site_name[]" placeholder="Site Two Name" autocomplete="off">
                      </div>
                      <div class="col-sm-3">
                        <input type="text" class="form-control achived_views"  name="achived_views[]" placeholder="Achieved Impressions" autocomplete="off">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control site_name"  name="site_name[]" placeholder="Site Three Name" autocomplete="off">
                      </div>
                      <div class="col-sm-3">
                        <input type="text" class="form-control achived_views"  name="achived_views[]" placeholder="Achieved Impressions" autocomplete="off">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control site_name"  name="site_name[]" placeholder="Site Four Name" autocomplete="off">
                      </div>
                      <div class="col-sm-3">
                        <input type="text" class="form-control achived_views"  name="achived_views[]" placeholder="Achieved Impressions" autocomplete="off">
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="pr_date" id="pr_date" autocomplete="off">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="rpt_date" id="rpt_date" autocomplete="off">
                        </div>
                      </div>
            ...
            <div class="col-md-6">
              <form id="save_email_media_list" name="save_email_media_list" method="post" action="#" enctype="multipart/form-data">
                <div class="card card-info">
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-info fourth-row" id="EmailMediaStatsButton" onclick="saveEmailMediaStats(event)">Save Email Media Stats</button>
        ...
        <div class="card-footer">
          ...
          <button type="submit" class="btn btn-lg btn-success" id="save_final_report" onclick="saveCampaign()">Finalize Report Data</button>
  ...
  $('[data-toggle="tooltip"]').tooltip()
    ...
    var sessionTimer = setInterval(function() {
      $.ajax({
        url: '<?php echo BASE_URL . 'utility/renew_session'; ?>',
        beforeSend: function() {},
  ...
  <script src="<?php echo ASSETS; ?>js/create-report.js?123"></script>
