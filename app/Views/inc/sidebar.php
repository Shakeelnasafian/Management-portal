<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <?php if(session()->get('user_session')->profile_image != ""){ ?>
           
                <img src="<?php echo session()->get('user_session')->profile_image; ?>" alt="Editorial user" class="brand-image img-circle elevation-3 user_iamge" style="opacity: .8">
            ...
            <div class="info">
                <a href="#" class="d-block"><?php echo session()->get('user_session')->user_login ?></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <?php if (session()->get('user_session')->icn_role == 'Editor' or session()->get('user_session')->icn_role == 'Administrator' or session()->get('user_session')->icn_role == 'Operations-Staff') { ?>
                ...
                <?php if (session()->get('user_session')->icn_role == 'SocialMedia-Staff' or session()->get('user_session')->icn_role == 'Administrator') { ?>
                ...
                if (session()->get('user_session')->icn_role == 'Operations-Staff' or session()->get('user_session')->icn_role == 'Administrator') { ?>
                ...
                if (session()->get('user_session')->icn_role == 'Editor' or session()->get('user_session')->icn_role == 'Administrator') { ?>
                ...
                if (session()->get('user_session')->icn_role == 'Editor' or session()->get('user_session')->icn_role == 'Administrator' or session()->get('user_session')->icn_role == 'SEO-Staff') { ?>
                ...
                <li class="nav-item has-treeview " id="managment_user">
                    ...
                    <ul class="nav nav-treeview sub-child">
                        ...
                        <?php
                        if (session()->get('user_session')->icn_role == 'Administrator') { ?>
                        ...
                        <?php } ?>
                        <li class="nav-item">
                            <a href="<?php echo BASE_URL . 'users/edit-profile/' . session()->get('user_session')->ID ?>" class="nav-link">
                ...
                <?php
                if (session()->get('user_session')->icn_role == 'Stake Holders' || session()->get('user_session')->icn_role == 'Administrator' || session()->get('user_session')->icn_role == 'Editor') { ?>
                ...
                <?php
                if (session()->get('user_session')->icn_role == 'Sales' or session()->get('user_session')->icn_role == 'Administrator') { ?>
