                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="post_date" placeholder="Enter Meta Title" autocomplete="off" name="post_date" required value="<?php echo $post->post_date; ?>">
                    </div>

                    <div class="form-group col-md-6">
                      <label for="search">Campaign Link</label>
                      <input type="text" class="form-control" id="c_link" placeholder="Enter Meta Title" autocomplete="off" name="cf_campaign_link" value="<?php echo $post->cf_campaign_link; ?>">
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select class="form-control valid" name="post_status" id="status" aria-invalid="false">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="cf_cont_info" rows="3"><?php echo $post->cf_cont_info; ?>
                    </textarea>
                  </div>
  ...
  <script type="text/javascript">
    ...
    $(function() {
      ...
      $(document).on('submit', '#edit_pressrelease', function(e) {
        ...
        $.ajax({
          type: 'POST',
          url: "<?php echo BASE_URL . 'operations/update-pressrelease/' . $post->ID ?>",
          contentType: false,
          processData: false,
          data: data,
          beforeSend: function() {
