...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">iCN Users</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header border-transparent">
              ...
              <h3 class="card-title">iCN Users</h3>
            ...
            <div class="table-responsive">
              <table class="table m-0">
                ...
                <tbody>
                  ...
                  <?php
                  if(isset($pressrelease_users['users'])){

                  foreach($pressrelease_users['users'] as $user){ ?>
                ...
                <tr>
                    ...
                    <td>
                    <?php if (in_array($user->ID, $user_posts)) { ?>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-info verify_pr_now" data-toggle="modal" id="<?php echo $user->ID; ?>" data-target="#modal-default">
                          View Details
                        </button>
                    </td>
                </tr>
  ...
  $(document).on('click', '.verify_pr_now', function(){  
        ...
        $.ajax({
          url:'<?php echo BASE_URL.'kiosk_users/get_pressrelease_user_details_ajax/'; ?>',
          type: 'POST',
          dataType: 'html',
          data:{
            user_id
