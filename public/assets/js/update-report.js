...
//console.log(campaign_summary_data);
createLocalStorage();

function createLocalStorage()
{
  saveToLocalStorage('campaign_summary', campaign_summary_data);
  saveToLocalStorage('keywords_targeted', keywords_targeted_data);
  saveToLocalStorage('targeting_information', targeting_information_data);
  saveToLocalStorage('gaw_campaign_summary', gaw_campaign_summary_data);
  saveToLocalStorage('ln_ft_campaign_summary', ln_ft_campaign_summary_data);
  saveToLocalStorage('goog_ind_campaign_summary', goog_ind_campaign_summary_data);
  saveToLocalStorage('fb_campaign_summary', fb_campaign_summary_data);
  saveToLocalStorage('link_campaign_summary', link_campaign_summary_data);
  saveToLocalStorage('premium_website_summary', premium_website_summary_data);
  saveToLocalStorage('social_media_data', social_media_Screen_shots);
  saveToLocalStorage('report_dates', report_dates_data);
  saveToLocalStorage('keywords_triggered', keywords_triggered_data);
  saveToLocalStorage('website_targeted_reports_stats', website_targeted_reports_data);
  saveToLocalStorage('heat_maps', heat_maps_data);
  saveToLocalStorage('premium_distribution', premium_distribution);
  saveToLocalStorage('mail_media_list', mail_media_list_data);
...
function saveGoogleIndexSummary(e) {
  ...
  function saveLinkedinCampaignSummary(e)
  {
      ...
      if(validated && linkdinGraphicImage !="" && linkdinJobFunctions !="" && linkLocations !=""){
...
function saveEmailMediaStats(e) {
  ...
  function saveCampaign(campaignId) {
    ...
    $.ajax({
        type: 'POST',
        url: BASE_URL+"reporting/update_final_report",
        dataType: 'json',
        cache: false,
        data: {
            ID: post_id,
        ...
        success: function (response) {
            ...
            if(response == 1){
              ...
              successMessage("#report_message", "Report Updated successfully");
